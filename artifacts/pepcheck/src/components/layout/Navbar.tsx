...
export function Navbar() {
  ...
  const resourceLinks = [
    { href: "/cheapest-tirzepatide", label: "Cheapest Tirzepatide" },
    { href: "/cheapest-semaglutide", label: "Cheapest Semaglutide" },
      ...
      <div className="container mx-auto px-4 md:px-8 flex h-16 items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm font-medium">
          ...
          <div className="relative" onMouseEnter={() => setResourcesOpen(true)} onMouseLeave={() => setResourcesOpen(false)}>
            ...
            {resourcesOpen && (
              <div className="absolute top-full left-0 mt-1 w-56 bg-background border rounded-xl shadow-lg py-1 z-50">
